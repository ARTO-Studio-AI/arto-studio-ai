...
| **Qué NO hacer** | No mandar email, nombre ni empresa a PostHog. No encender autocapture ni session replay sin decisión de Victor. No cambiar la cookie `asai_utm` a último toque. No convertir Empresa y Rol en obligatorios. No mandar correos desde `resend-audience.ts` (los envíos pasan por Fable, están fuera del auto-fix) |
